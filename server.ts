...
Объем строго ${data.pages} страниц формата A4.
Примерный объем текста: ${wordsMin} – ${wordsMax} слов.

Работа должна содержать:
- Введение
- Основную часть (несколько глав)
- Заключение
- Список литературы

Текст должен быть подробным, научным и соответствовать школьному уровню.
